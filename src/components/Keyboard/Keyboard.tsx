...
const Keyboard = (props: KeyboardProps) => {
  ...
  const buttonClass = `rounded uppercase bg-gray-600/40 h-12 w-8 mr-1 mb-2 min-w-fit text-white text-xl`;
  ...
  return (
    <div className="keyboard flex flex-col items-center mt-auto mb-4">
